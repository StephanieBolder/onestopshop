...
import { Card, Row, Container, Col, Badge, Alert, Button } from "react-bootstrap";
import '../App.css';
...
export default function More() {
    ...
    return (
        <div>
            <div>
                {state && state.alert && (
                    <Alert style={{marginTop: "50px", paddingTop: "20px", paddingBottom: "20px", backgroundColor: "#E1EDFF", border: "none", borderRadius: "11px"}}>
                        {state.alert.text}
                        <a style={{marginLeft: "10px", fontWeight: "600", textDecoration: "none"}} href={state.alert.link.route}>{state.alert.link.label}</a>
                    </Alert>
                )}
                <div style={{marginTop: "100px"}}>
                    <div className="d-flex flex-row justify-content-center  align-items-start">
                        <div className="content-blob-white">
                            <Title title="Yogastudio Namasté"></Title>
                    ...
                    <div style={{marginLeft: "250px", width: "100%"}} className="d-flex flex-row justify-content-start">
                        <div className="content-blob-white">
